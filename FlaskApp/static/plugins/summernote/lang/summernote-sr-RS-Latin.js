€–~Âøﬂ¢Êππ˛Eb/–Ÿ*ŒádQËXeQ)Ãë≠⁄.‰8™ht=V˜z{Çß∞È˙ïZµñ¨‚Å'-ê–ØîÒŒ,#t{.˙ùFãùRÄ`A/*!
 * 
  ...
  $.extend($.summernote.lang, {
    'sr-RS': {
      font: {
        ...
        size: 'Veliƒçina fonta'
      },
      image: {
        image: 'Slika',
        insert: 'Umetni sliku',
        resizeFull: 'Puna veliƒçina',
      ...
      paragraph: {
        paragraph: 'Paragraf',
        outdent: 'Smanji uvlaƒçenje',
        indent: 'Poveƒçaj uvlaƒçenje',
      ...
      shortcut: {
        shortcuts: 'Preƒçice sa tastature',
        close: 'Zatvori',
