...
import { MultiDict } from "../core/util/data_structures";
...
export declare class Document {
    ...
    rimport { BokehEvent } from "../core/bokeh_events";
import { HasProps } from "../core/has_props";
import { Attrs } from "../core/types";
import { Signal0 } from "../core/signaling";
import { Struct } from "../core/util/refs";
...
export declare class Document {
    ...
    static _references_json(references: HasProps[], include_defaults?: boolean): Struct[];
    static _instantiate_object(obj_id: string, obj_type: string, obj_attrs: Attrs): HasProps;
    static _instantiate_references_json(references_json: Struct[], existing_models: {
        [key: string]: HasProps;
    }): References;
    ...
    static _event_for_attribute_change(changed_obj: Struct, key: string, new_value: any, doc: Document, value_refs: {
        [key: string]: HasProps;
    }): ModelChanged | null;
    static _events_to_sync_objects(from_obj: Struct, to_obj: Struct, to_doc: Document, value_refs: {
        [key: string]: HasProps;
    }): ModelChanged[];
