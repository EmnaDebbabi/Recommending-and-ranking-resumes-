...
def gradient(f, *varargs, **kwargs):
    ...
    if n == 0:
        ...
        for i, distances in enumerate(dx):
            ...
            if len(distances) != f.shapefrom __future__ import division, absolute_import, print_function
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    Notes
    -----
    Given a vector from __future__ import division, absolute_import, print_function
